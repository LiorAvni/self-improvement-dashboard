...
export const monthPlans: MonthPlan[] = [
  {
    ...
    generalExplanation: 'Month 1 is June. The first part of the month, June 1–19, is still school time with a heavy schedule: Sunday has school, piano, and university; Wednesday is long and crowded; Friday is a long school day; and Saturday has family time. The safest evidence-based plan is therefore 3 main sessions per week on Monday, Thursday, and Saturday morning. From June 20–30 the schedule becomes summer: Sunday has piano, Monday and Wednesday have two university blocks, Tuesday has evening university, and Thursday/Friday/Saturday are open. The plan switches to the summer split from June 20 so the app does not keep using school anchors after school ends.',
    bestWeeklySplit: 'June 1–19 school split: Monday = Upper Push + Core, Thursday = Upper Pull + Posture, Saturday morning = Legs + Core + Athletic Base. June 20–30 summer split: Tuesday = Upper Push + Core, Thursday = Upper Pull + Posture, Saturday = Legs + Core + Athletic Base, with Friday optional skill/recovery.',
    ...
    weeklyAlternates: [
      {
        label: 'June 20–30 summer division',
        subtitle: 'Use this after school ends on June 20. Monday and Wednesday have two university blocks, Tuesday has evening university, and Thursday/Friday/Saturday are the most open days.',
        weeklyDays: [
          ...
          { day: 'Monday', priority: 'Recovery', timing: 'University 8:45–12:15 and 17:45–21:15', exactTask: 'No main workout. Do posture or a short walk only.', whyThisDay: 'Two university blocks make Monday too crowded for a reliable hard session.' },
          { day: 'Tuesday', priority: 'Main', workoutId: 'upper-push-core', timing: 'Late morning or afternoon before 18:00 university', exactTask: 'Upper Push + Core. Keep it strict and technique-first; do not turn the first summer sessions into max tests.', whyThisDay: 'Tuesday has one evening university block, so the earlier part of the day is usable.' },
  ...
  },
  {
    ...
    generalExplanation: 'Month 2 is July, and with the corrected schedule it is fully summer time. There is no school in July. The known summer pattern is: Sunday piano, Monday university 8:45–12:15 and 17:45–21:15, Tuesday university 18:00–21:20, Wednesday university 8:45–12:15 and 17:45–21:15, and Thursday/Friday/Saturday open. Because Monday and Wednesday are university-heavy, they are not main workout anchors. The best summer split is Tuesday, Thursday, and Saturday, with Friday as the optional skill/recovery day.',
    bestWeeklySplit: 'July summer split: Tuesday = Upper Push + Core before evening university, Thursday = Upper Pull + Posture on the open day, Saturday = Legs + Core + Athletic Base. Friday = optional Skill + Recovery + Light Conditioning if recovery is good.',
    expectedWeeklyTime: 'Three required sessions: about 95–125 minutes per week. Optional Friday skill/recovery adds 15–25 minutes. Daily posture/mobility remains 5 minutes and should feel easy.',
    ...
    mainTargets: ['3 workouts per week through the full month', 'More total pull-up and push-up volume', 'Better control on dips and pike push-ups', 'Dinner becomes more reliable', 'Optional skill/recovery day appears only when useful', 'No elbow/shoulder irritation from added volume'],
    weeklyDays: [
      { day: 'Sunday', priority: 'Recovery', timing: 'Piano 16:00–17:20', exactTask: 'Recovery, light walk, posture routine, and weekly planning. No hard workout.', whyThisDay: 'Sunday should set up the week rather than create fatigue before the university-heavy Monday.' },
  ...
  },
  {
    ...
    generalExplanation: 'Month 3 is August, which is fully summer schedule. The known pattern remains: Sunday piano, Monday two university blocks, Tuesday evening university, Wednesday two university blocks, and Thursday/Friday/Saturday open. This is the best month for consistent progress because there is no school, but the plan still avoids Monday and Wednesday because those days are crowded. The main split stays Tuesday, Thursday, and Saturday. The difference from July is that the exercises become slightly harder: more strict pull-up volume, more controlled dips/push-ups, more challenging leg variations, and small skill-prep progressions.',
  ...
  },
  {
    ...
    phaseGoal: 'Keep summer strength progress while transitioning back to school and finishing the old university schedule on September 10.',
    generalExplanation: 'Month 4 is September, a transition month. School is expected to return in the mornings Sunday–Friday, and the previous university schedule still continues until September 10. That means the first 10 days may be crowded, especially Monday and Wednesday with two university blocks and Tuesday evening university. After September 10, the old university schedule ends and September becomes mostly school-only until the new university semester later in October. The plan uses a conservative early-September split and then returns to a school-friendly Monday/Thursday/Saturday structure.',
    bestWeeklySplit: 'September 1–10 transition split: Thursday = Upper Push, Friday = Upper Pull, Saturday = Legs/Core, because Monday/Tuesday/Wednesday are university-heavy. September 11–30 school-only estimate: Monday = Upper Push, Thursday = Upper Pull, Saturday = Legs/Core, with Tuesday optional skill only if school load is manageable.',
    ...
    weeklyDays: [
      ...
      { day: 'Wednesday', priority: 'Recovery', timing: 'University-heavy until September 10; assume recovery afterward unless schedule proves easy', exactTask: 'Rest, posture, or light walking.', whyThisDay: 'Wednesday was previously very heavy and should not be assumed free.' },
    ...
    weeklyAlternates: [
      {
        ...
        subtitle: 'Use this while school is restarting and the old university schedule still runs until September 10.',
        weeklyDays: [
